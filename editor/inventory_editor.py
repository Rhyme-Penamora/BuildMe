...
# =============================================================================
"""
Inventory editor for viewing and managing player inventory.
"""
...
class InventoryEditor:
    ...
    def open(self, inventory: Inventory) -> None:
        """
        Open inventory editor with given inventory.
    ...
    def _update_display(self) -> None:
        """Rebuild inventory item list display."""
        if not self.inventory:
            return

        html_lines = ["<font face='monospace' size=3>"]
        has_items = False
